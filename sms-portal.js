...
const SMS_CONFIG = {
    CLIENT_ID: process.env.SMS_PORTAL_CLIENT_ID,
    CLIENT_SECRET: process.env.SMS_PORTAL_CLIENT_SECRET,
    BASE_URL: process.env.SMS_PORTAL_BASE_URL || 'https://rest.smsportal.com',
    SENDER_ID: process.env.SMS_PORTAL_SENDER_ID || 'RetailSolutions'
};
...
app.post('/api/sms/send', async (req, res) => {
    try {
        ...
        const requestBody = {
            ...
            ...(SMS_CONFIG.SENDER_ID && { senderId: SMS_CONFIG.SENDER_ID })
        };
